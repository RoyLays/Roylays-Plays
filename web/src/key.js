...
const modernCodeMap = {
    ...codeMap,
    // WASD → Arrow key codes for movement
    'KeyW': 38,  // Up
    'KeyA': 37,  // Left
    'KeyS': 40,  // Down
    'KeyD': 39,  // Right
...
/**
 * Returns the appropriate code map for the given control scheme.
 * @param {string} scheme - 'classical', 'modern', or 'pro'
 * @returns {object} The key-to-keycode mapping object
 */
export function getCodeMap(scheme) {
    switch (scheme) {
        case 'modern':
            return modernCodeMap;
        case 'pro':
            // Pro uses controller, but keyboard fallback uses classical map
            return codeMap;
        case 'classical':
        default:
            return codeMap;
